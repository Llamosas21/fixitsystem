...
class LoginWindow(QWidget): #Se construye la ventana de inicio de sesión
    def __init__(self):
        ...
        self.label_titulo.setContentsMargins(0, 50, 0, 0)  # Agrega 50px arriba
        ...
        self.input_usuario.setStyleSheet(
            "QLineEdit {background-color: #102540; color: #fff; border-radius: 10px; padding: 10px;}")
        ...
        self.boton_ingresar.setStyleSheet(
            "QPushButton {background-color: #102540; color: #fff; border-radius: 10px; padding: 10px;}")
        ...
        self.frame.layout().addWidget(self.input_usuario, alignment=Qt.AlignHCenter | Qt.AlignVCenter)
        self.frame.layout().addWidget(self.input_contraseña, alignment=Qt.AlignHCenter | Qt.AlignVCenter)
        self.frame.layout().addWidget(self.boton_ingresar, alignment=Qt.AlignHCenter | Qt.AlignVCenter)
